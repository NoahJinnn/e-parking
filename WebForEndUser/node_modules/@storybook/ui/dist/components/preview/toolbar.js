...
var ToolRes = function ToolRes(_ref6) {
  var api = _ref6.api,
      story = _ref6.story,
      tabs = _ref6.tabs,
...
var ToolbarComp = function ToolbarComp(p) {
  return /*#__PURE__*/_react["default"].createElement(_router.Location, null, function (l) {
    return /*#__PURE__*/_react["default"].createElement(ToolRes, _extends({}, l, p));
  });
};

exports.ToolbarComp = ToolbarComp;
ToolbarComp.displayName = "ToolbarComp";

var Tools = function Tools(_ref7) {
  var list = _ref7.list;
  return list.filter(Boolean).reduce(function (acc, _ref8, index) {
    var Render = _ref8.render,
        id = _ref8.id,
        t = _objectWithoutProperties(_ref8, ["render", "id"]);

    // @ts-ignore
    var key = id || t.key || "f-".concat(index);
    return /*#__PURE__*/_react["default"].createElement(_react.Fragment, {
      key: key
    }, acc, /*#__PURE__*/_react["default"].createElement(Render, null));
  }, null);
};

exports.Tools = Tools;

function filterTools(tools, toolsExtra, tabs, _ref9) {
  var viewMode = _ref9.viewMode,
      story = _ref9.story,
