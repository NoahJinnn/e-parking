...
var IFrame = /*#__PURE__*/function (_Component) {
  ...
  _createClass(IFrame, [{
    ...
    value: function setIframeInnerZoom(scale) {
      try {
        if (_global["default"].navigator.userAgent.indexOf(FIREFOX_BROWSER) !== -1) {
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["id", "title", "src", "allowFullScreen", "scale", "active"]);

      return /*#__PURE__*/_react["default"].createElement(StyledIframe, _extends({
        onLoad: function onLoad() {
          return _this2.iframe.setAttribute('data-is-loaded', 'true');
        },
