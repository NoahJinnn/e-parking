...
var Input = _theming.styled.input(function (_ref3) {
  ...
  return {
    ...
    paddingLeft: 28,
    paddingRight: 28,
    border: "1px solid ".concat(theme.color.mediumdark, "66"),
...
var Search = function Search(_ref6) {
  ...
  var getResults = (0, _react.useCallback)(function (input) {
    if (!input) return [];
    var results = [];
    var componentResults = fuse.search(input).filter(function (_ref9) {
      var item = _ref9.item;
  ...
  return /*#__PURE__*/_react["default"].createElement(_downshift["default"], {
    ...
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(ScreenReaderLabel, getLabelProps(), "Search for components"), /*#__PURE__*/_react["default"].createElement(SearchField, getRootProps({
      refKey: ''
    }, {
