...
var Node = /*#__PURE__*/_react["default"].memo(function (_ref2) {
  var item = _ref2.item,
      refId = _ref2.refId,
      isOrphan = _ref2.isOrphan,
      isDisplayed = _ref2.isDisplayed,
      isSelected = _ref2.isSelected,
      isHighlighted = _ref2.isHighlighted,
      isFullyExpanded = _ref2.isFullyExpanded,
      setFullyExpanded = _ref2.setFullyExpanded,
  ...
  if ((0, _api.isRoot)(item)) {
    return /*#__PURE__*/_react["default"].createElement(_TreeNode.RootNode, {
      ...
      "data-item-id": item.id,
      "data-nodetype": "root"
    }, item.name, /*#__PURE__*/_react["default"].createElement(Action, {
      type: "button",
...
var Root = /*#__PURE__*/_react["default"].memo(function (_ref3) {
  var setExpanded = _ref3.setExpanded,
      isFullyExpanded = _ref3.isFullyExpanded,
      expandableDescendants = _ref3.expandableDescendants,
      props = _objectWithoutProperties(_ref3, ["setExpanded", "isFullyExpanded", "expandableDescendants"]);
...
var Tree = /*#__PURE__*/_react["default"].memo(function (_ref4) {
  var isBrowsing = _ref4.isBrowsing,
      isMain = _ref4.isMain,
      refId = _ref4.refId,
      data = _ref4.data,
      highlightedItemId = _ref4.highlightedItemId,
      setHighlightedItemId = _ref4.setHighlightedItemId,
      selectedStoryId = _ref4.selectedStoryId,
      onSelectStoryId = _ref4.onSelectStoryId;
  ...
  var _useMemo = (0, _react.useMemo)(function () {
    return Object.keys(data).reduce(function (acc, id) {
      ...
      rootIds = _useMemo2[0],
      orphanIds = _useMemo2[1]; // Pull up (hoist) any "orphan" items that don't have a root item as ancestor so they get
  ...
  var singleStoryComponents = (0, _react.useMemo)(function () {
  ...
  var collapsedItems = (0, _react.useMemo)(function () {
    return orphansFirst.filter(function (id) {
      return !singleStoryComponents.includes(id);
    });
  }, [orphansFirst, singleStoryComponents]); // Rewrite the dataset to place the child story in place of the component.

  var collapsedData = (0, _react.useMemo)(function () {
    return singleStoryComponents.reduce(function (acc, id) {
      var _ref5 = data[id],
  ...
  }, [data]); // Track expanded nodes, keep it in sync with props and enable keyboard shortcuts.
  ...
  return /*#__PURE__*/_react["default"].createElement(Container, {
    ...
    var isDisplayed = !item.parent || (0, _utils.getAncestorIds)(collapsedData, itemId).every(function (a) {
      return expanded[a];
    });
