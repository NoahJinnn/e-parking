...
var useHighlighted = function useHighlighted(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (highlight) {
      ...
      setTimeout(function () {
        (0, _utils.scrollIntoView)(containerRef.current.querySelector("[data-item-id=\"".concat(itemId, "\"][data-ref-id=\"").concat(refId, "\"]")), true // make sure it's clearly visible by centering it
        );
      }, 0);
    }
  }, [dataset, highlightedRef, selected]); // Highlight nodes up/down the tree using arrow keys
  ...
  (0, _react.useEffect)(function () {
    ...
    var navigateTree = (0, _throttle["default"])(function (event) {
      ...
      var nextIndex = (0, _utils.cycle)(highlightable, currentIndex, event.key === 'ArrowUp' ? -1 : 1);
      var didRunAround = event.key === 'ArrowDown' && nextIndex === 0 || event.key === 'ArrowUp' && nextIndex === highlightable.length - 1;
