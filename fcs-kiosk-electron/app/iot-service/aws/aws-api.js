  ...
  .command(
    ...
    function (yargs) {
      yargs
        .option('endpoint', {
          alias: 'e',
          description: 'Your AWS IoT custom endpoint, not including a port. ' + 'Ex: "abcd123456wxyz-ats.iot.us-east-1.amazonaws.com"',
          type: 'string',
          required: true,
        })
        .option('ca_file', {
        ...
        .option('topic', {
          ...
          type: 'string',
          default: 'fuck/localgateway_to_awsiot',
        })
        .option('count', {
          alias: 'n',
          default: 10,
        ...
        .option('signing_region', {
          alias: 's',
          default: 'us-east-1',
          description: 'If you specify --use_websocket, this ' + 'is the region that will be used for computing the Sigv4 signature',
          type: 'string',
          required: false,
        })
        .option('proxy_host', {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  on_publish = function (topic, payload) {
                    return __awaiter(_this, void 0, void 0, function () {
                      var json, message
                      return __generator(this, function (_a) {
...
function main (argv) {
  return __awaiter(this, void 0, void 0, function () {
    var level, client_bootstrap, config_builder, proxy_options, timer, config, client, connection
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
        ...
        case 1:
          ...
          return [
            4 /* yield */,
            execute_session(connection, argv),
