...
export default function MobileMethodIcon({ className, width, height }: ISvgComponentProps) {
  return (
    <div className={className}>
      <svg xmlns="http://www.w3.org/2000/svg" width="29.1" height="42.5" viewBox="0 0 110.351 189.961">
        <g id="icon-passcode">
          <path
            stroke="#3c3c3c"
            id="Path_498"
