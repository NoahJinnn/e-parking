...
function () {
  ...
  (0, _createClass2["default"])(Routes, [{
    ...
    value: function add(name, pattern, page) {
      var disableLocales = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
      var options;
      var locales;
      locales = this.locales.filter(function (item) {
        return !disableLocales.includes(item);
      });
      ...
      options.pattern = "/:lang(".concat(locales.join('|'), ")?").concat(this.prefix).concat(options.pattern || "/".concat(options.name));
    ...
    value: function match(url) {
      ...
      var reducer = this.routes.reduce(function (result, route) {
        ...
        return (0, _objectSpread2["default"])({}, result, {
          route: route,
          params: params,
          query: (0, _objectSpread2["default"])({}, query, params)
        });
      }, {
        query: query,
        parsedUrl: parsedUrl
      });
      reducer.query = (0, _objectSpread2["default"])({}, reducer.query, {
    ...
    value: function getLink(Link) {
      ...
      var LinkRoutes = function LinkRoutes(props) {
        var route = props.route,
            params = props.params,
            to = props.to,
            newProps = (0, _objectWithoutProperties2["default"])(props, ["route", "params", "to"]);
        var nameOrUrl = route || to;

        if (nameOrUrl) {
          (0, _assign["default"])(newProps, _this2.findAndGetUrls(nameOrUrl, params).urls);
        }
...
function () {
  function Route(_ref2) {
    var name = _ref2.name,
        ...
        _ref2$disableLocales = _ref2.disableLocales,
        disableLocales = _ref2$disableLocales === void 0 ? [] : _ref2$disableLocales;
  ...
  (0, _createClass2["default"])(Route, [{
    ...
    value: function valuesToParams(values) {
      ...
      return values.reduce(function (params, val, i) {
        ...
        return (0, _assign["default"])(params, (0, _defineProperty2["default"])({}, _this4.keys[i].name, decodeURIComponent(val)));
      }, {});
    }
  }, {
    key: "getHref",
...
var toQuerystring = function toQuerystring(obj) {
  return (0, _keys["default"])(obj).filter(function (key) {
